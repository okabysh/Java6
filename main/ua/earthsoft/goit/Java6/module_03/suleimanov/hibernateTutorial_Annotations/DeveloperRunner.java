package ua.earthsoft.goit.Java6.module_03.suleimanov.hibernateTutorial_Annotations;
...
//        developerRunner.addDeveloper("Illya", "Chobot", "PHP", 5);
        ...
        developerRunner.updateDeveloper(7,11);
        ...
        developerRunner.removeDeveloper(7);
        developers = developerRunner.listDevelopers();
        for (Developer developer : developers) {
            System.out.println(developer.toString());
        }
